...
public class BqCode {
    ...
    //为了使账面冲平引入的调整金 Add by QianLy on 2007-11-6
    public static final String Pos_Adjust = "MPOS";
    
	public static final String  Get_ApMoney = "P018";  //  QF保全追加保费
	public static final String  Get_ApCSMoney ="P019" ;  //  QS保全追加保费初始费用
